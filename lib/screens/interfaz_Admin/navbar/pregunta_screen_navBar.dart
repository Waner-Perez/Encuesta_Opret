...
class _PreguntaScreenNavbarState extends State<PreguntaScreenNavbar> {
  ...
  final ApiServicePreguntas _apiServicePreguntas = ApiServicePreguntas('http://api.encuesta.opret.gob.do:5020');
  late Future<List<Preguntas>> _preguntasData;
  final ApiServiceSubPreguntas  _apiServiceSubPreguntas = ApiServiceSubPreguntas('http://api.encuesta.opret.gob.do:5020');
  late Future<List<SubPregunta>> _subPreguntasData;
  final ApiServiceSesion _apiServiceSesion = ApiServiceSesion('http://api.encuesta.opret.gob.do:5020');
            ...
            TextButton(
              onPressed: () async {
                if (_formKey.currentState!.saveAndValidate()) {
                  ...
                  Preguntas? existingQuestion = await ApiServicePreguntas('http://api.encuesta.opret.gob.do:5020').getOnePregunta(newQuestion);
                  ...
                  try{
                    final response = await ApiServicePreguntas('http://api.encuesta.opret.gob.do:5020').postPreguntas(nuevaPregunta);
            ...
            TextButton(
              onPressed: () async {
                if(_formKey.currentState!.saveAndValidate()){
                  ...
                  try{
                    final response = await ApiServicePreguntas('http://api.encuesta.opret.gob.do:5020')
            ...
            TextButton(
              onPressed: () async {
                if(_formKey.currentState!.saveAndValidate()){
                  ...
                  SubPregunta? existingSubPregunta = await ApiServiceSubPreguntas('http://api.encuesta.opret.gob.do:5020').getOneSubPreg(newSubPregunta);
                  ...
                  try{
                    final response = await ApiServiceSubPreguntas('http://api.encuesta.opret.gob.do:5020').postSubPreg(nuevaSubPregunta);
            ...
            TextButton(
              onPressed: () async {
                if(_formKey.currentState!.saveAndValidate()) {
                  ...
                  try{
                    final response = await ApiServiceSubPreguntas('http://api.encuesta.opret.gob.do:5020')
            ...
            TextButton(
              onPressed: () async {
                if (_formKey.currentState!.saveAndValidate()) {
                  ...
                  try{
                    final response = await ApiServiceSesion('http://api.encuesta.opret.gob.do:5020').postSesion(nuevaSesion);
            ...
            TextButton(
              onPressed: () async {
                if(_formKey.currentState!.saveAndValidate()) {
                  ...
                  try{
                    final response = await ApiServiceSesion('http://api.encuesta.opret.gob.do:5020')
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () async {
                try{
                  final response = await ApiServiceSesion('http://api.encuesta.opret.gob.do:5020').deleteSesion(sectionDelete.idSesion!);
  ...
  void _actualizarEstadoTodasSesiones(bool nuevoEstado) async {
    try {
      for (var sesion in _sesionFiltrada) {
        ...
        final response = await ApiServiceSesion('http://api.encuesta.opret.gob.do:5020').putSesion(sesion.idSesion!, estadoActualizador);
